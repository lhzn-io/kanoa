...
COPILOT_DEPS = ["github-copilot-sdk>=0.1.0"]
...
setup(
    ...
    extras_require={
        ...
        + GCLOUD_DEPS
        + VERTEXAI_DEPS,
        "backends": GEMINI_DEPS + CLAUDE_DEPS + OPENAI_DEPS + COPILOT_DEPS,
        # Development
        "dev": DEV_DEPS
        + GEMINI_DEPS
        + CLAUDE_DEPS
    ...
    keywords="ai llm data-science analytics gemini claude openai copilot jupyter",
    entry_points={
        "console_scripts": [
